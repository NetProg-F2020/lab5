...
class RouteGuideStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RouteRetrieve = channel.unary_stream(
                '/routeguide.RouteGuide/RouteRetrieve',
                request_serializer=route__guide__pb2.PointID.SerializeToString,
                response_deserializer=route__guide__pb2.Point.FromString,
                )
...
def add_RouteGuideServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'RouteRetrieve': grpc.unary_stream_rpc_method_handler(
                    servicer.RouteRetrieve,
                    request_deserializer=route__guide__pb2.PointID.FromString,
                    response_serializer=route__guide__pb2.Point.SerializeToString,
            ),
    }
...
class RouteGuide(object):
    ...
    def RouteRetrieve(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/routeguide.RouteGuide/RouteRetrieve',
            route__guide__pb2.PointID.SerializeToString,
            route__guide__pb2.Point.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
