...
_ROUTESUMMARY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='this_id', full_name='routeguide.RouteSummary.this_id', index=4,
...
_POINTID = _descriptor.Descriptor(
  name='PointID',
  full_name='routeguide.PointID',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='request_id', full_name='routeguide.PointID.request_id', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['PointID'] = _POINTID
...
PointID = _reflection.GeneratedProtocolMessageType('PointID', (_message.Message,), {
  'DESCRIPTOR' : _POINTID,
  '__module__' : 'route_guide_pb2'
  # @@protoc_insertion_point(class_scope:routeguide.PointID)
  })
...
_ROUTEGUIDE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='RouteRetrieve',
    full_name='routeguide.RouteGuide.RouteRetrieve',
    index=4,
    containing_service=None,
    input_type=_POINTID,
    output_type=_POINT,
